...
<br>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        País: <select class="form-control" name="pais" required>
        ...
        <br>
        Estado: <select class="form-control" name="estado" required>
        ...
        <br>
        Endereço: <input class="form-control" type="text" name="endereco" required >
        <br>
        Número: <input class="form-control" type="number" name="numero" required >
        <br>
